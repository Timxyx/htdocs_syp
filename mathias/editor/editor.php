    ...
    <div class="container min-w-full flex justify-center">
        <form action="editor.php" method="POST" class="bg-gray-800 p-5"> 
            ...
            <div class="flex flex-rows w-full space-between">
                ...
                <input class="special bg-white" type="submit" name="submit" value="back" placeholder=""></input><span class="textSpan" ></span></input>
                <input class="special bg-white" type="submit" name="submit" value="<?php echo $mode == 'up' ? 'down' : 'up' ?>" placeholder=""></input><span class="textSpan" ></span></input>
                <input class="special bg-white" type="submit" name="clear" value="<?php echo $clear?>" placeholder=""></input><span class="textSpan" ></span></input>
